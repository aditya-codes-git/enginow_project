    ...
    <div className="bg-theme-surface text-theme-text">
      ...
      <section className="relative overflow-hidden pt-12 pb-16 sm:pt-16 sm:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-100 bg-theme-surface/80 px-3.5 py-1.5 text-xs font-semibold text-theme-primary shadow-sm backdrop-blur-sm mb-6">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold shadow-md transition hover:-translate-y-0.5 hover:shadow-lg hover:opacity-95"
            >
              Browse events
            ...
            {[
              ...
              return (
                <div key={stat.label} className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-theme-bg border border-theme-divider text-theme-primary shrink-0">
